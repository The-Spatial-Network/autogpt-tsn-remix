...
// Disabled: import { SpeedInsights } from "@vercel/speed-insights/next";
// Disabled: import { Analytics } from "@vercel/analytics/next";

export const metadata: Metadata = {
  title: "AutoGPT Platform",
  description: "Your one stop shop to creating AI Agents",
  metadataBase: new URL(process.env.NEXT_PUBLIC_FRONTEND_BASE_URL || "http://autogpt.thespatialnetwork.net"),
};
